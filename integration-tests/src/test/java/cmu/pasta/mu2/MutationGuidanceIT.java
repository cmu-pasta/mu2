...
public class MutationGuidanceIT extends AbstractMutationTest {
  ...
  public void fuzzTimSortO1() throws Exception {
    // Set up test params
    String testClassName = "cmu.pasta.mu2.examples.sort.TimSortTest";
    ...
    // Create guidance
    MutationClassLoaders mcls = initClassLoaders(targetInst, "cmu.pasta.mu2.examples.sort", OptLevel.EXECUTION);
  ...
  public void fuzzTimSortO2() throws Exception {
    ...
    // Create guidance
    MutationClassLoaders mcls = initClassLoaders(targetInst, "cmu.pasta.mu2.examples.sort", OptLevel.INFECTION);
    ProbedMutationGuidance mu2 = new ProbedMutationGuidance(mcls, trials, rnd);
