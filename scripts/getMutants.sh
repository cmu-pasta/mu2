...
getResults() {
    ...
    mvn jqf:mutate -Dclass=$1 -Dmethod=$2 -Dincludes=$3 -Dinput=target/tmpZest/corpus > results/zest-results-$4.txt
    mvn jqf:mutate -Dclass=$1 -Dmethod=$2 -Dincludes=$3 -Dinput=target/tmpMu2/corpus > results/mutate-results-$4.txt
