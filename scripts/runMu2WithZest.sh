...
fuzzMu2Time() {
    ...
    echo mvn mu2:diff -Dclass="$2" -Dmethod="$3" -Dincludes="$4" -Din="target/$6-fuzz-results/zest/exp_$7/time_constrained_corpus/" -Dout="$6-fuzz-results/$1/exp_$7" -DrandomSeed="$7" -Dtime="$8" -DoptLevel=INFECTION -Djqf.mutation.TIMEOUT_TICKS=10000000
    mvn mu2:diff -Dclass="$2" -Dmethod="$3" -Dincludes="$4" -Din="target/$6-fuzz-results/zest/exp_$7/time_constrained_corpus/" -Dout="$6-fuzz-results/$1/exp_$7" -DrandomSeed="$7" -Dtime="$8" -DoptLevel=INFECTION -Djqf.mutation.TIMEOUT_TICKS=10000000
}
